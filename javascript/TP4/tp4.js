...
const addUserDialog = document.getElementById('show-user-dialog');
const userDialog = document.getElementById('user-dialog');
const closDialog = document.getElementById('close-dialog');
addUserDialog.addEventListener('click', () => {
    userDialog.showModal();
});
closDialog.addEventListener('click', () => {
    userDialog.close();
});
